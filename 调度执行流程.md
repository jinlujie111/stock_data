...
| 市场广度 DWD | `run_dwd_market_breadth 20260527` 或 `bash dw-dwd/pro_dwd_market_breadth_di.sh`（依赖当日 `ods_stock_detail_di` 已同步） |
...
| `dw-dwd/pro_dwd_market_breadth_di.sh` | 全市场广度 DWD ETL |
