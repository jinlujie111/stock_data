...
```text
stock_company     → ods_stock_company_di   (sync_mode=full, monthly, 月批)
fina_mainbz_vip   → ods_fina_mainbz_di   (sync_mode=snapshot 近2季, monthly, 月批)
fina_mainbz       → ods_fina_mainbz_di   (incremental 按股补全, monthly, 月批)
```
