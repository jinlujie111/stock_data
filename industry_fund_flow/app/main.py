...
from app import auth_service, routes_dc, routes_dragon, routes_hot_stocks, routes_limit_up, routes_mainline, routes_quant_mainline, routes_sectors, routes_volatility, routes_vp
