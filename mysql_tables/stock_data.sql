...
-- 已下线：量化主线 / 波动率（见 migrations/20260714_drop_quant_volatility.sql）
...
CREATE TABLE IF NOT EXISTS dwm_board_timing_signal_di (
    ...
    content_type        VARCHAR(16)    NULL COMMENT '��ҵ/����/����',
    close               DECIMAL(20, 6) NULL COMMENT '���̵�λ',
    ma20                DECIMAL(20, 6) NULL COMMENT '20�վ���',
    ma60                DECIMAL(20, 6) NULL COMMENT '60�վ���',
    score               DECIMAL(10, 2) NULL COMMENT '�ۺϷ�0-100',
    score_trend         DECIMAL(10, 2) NULL COMMENT '���Ʒ�',
    score_fund          DECIMAL(10, 2) NULL COMMENT '�ʽ��',
    score_vp            DECIMAL(10, 2) NULL COMMENT '���۷�',
    score_sentiment     DECIMAL(10, 2) NULL COMMENT '������',
    signal_type         VARCHAR(8)     NOT NULL DEFAULT 'none' COMMENT 'buy/sell/none',
    signal_reason       VARCHAR(512)   NULL COMMENT '����ԭ��',
    position_state      VARCHAR(16)    NULL COMMENT 'long/flat/watch',
    mom20               DECIMAL(20, 6) NULL COMMENT '20�ն���(С��)',
    flow5               DECIMAL(20, 4) NULL COMMENT '5�������������ۼ�(Ԫ)',
    net_inflow_days     INT            NULL COMMENT '��������������',
    amount_ratio20      DECIMAL(20, 6) NULL COMMENT '��/��MA20',
    up_ratio            DECIMAL(20, 6) NULL COMMENT '���Ǽ���ռ��',
    limit_up_ratio      DECIMAL(20, 6) NULL COMMENT '��ͣ��ɢ��',
    sentiment_overheat  TINYINT        NOT NULL DEFAULT 0 COMMENT '���������۶�',
    last_buy_close      DECIMAL(20, 6) NULL COMMENT '�������ο���(ֹ����)',
    rank_score          INT            NULL COMMENT '�ۺϷֽ�������',
    created_at          DATETIME       NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at          DATETIME       NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='���ư����������ʱ�ź�(����/�ʽ�/����/����)';
