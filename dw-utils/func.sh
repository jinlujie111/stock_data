...
# 阿里云 + Cloudflare 域名常无纯 A 记录，Python 可能 Network unreachable；curl -4 正常时应保持 1
TUSHARE_FORCE_IPV4="${TUSHARE_FORCE_IPV4:-1}"
# trade_cal 全量区间（sync_mode=full 时生效）
TUSHARE_TRADE_CAL_START_DATE="${TUSHARE_TRADE_CAL_START_DATE:-19900101}"
...
export TUSHARE_HTTP_URL TUSHARE_FORCE_IPV4
